...
export function MobileMenuDrawer({ onNewChat, onOpenLibrary }: MobileMenuDrawerProps) {
    ...
    <>
      ...
      <button
        ...
        className={cn(
          ...
          "p-2.5 rounded-xl backdrop-blur-xl shadow-lg border transition-all",
          "bg-white/80 border-white/60 text-slate-600 hover:bg-white hover:scale-105",
          "dark:bg-black/60 dark:border-white/10 dark:text-slate-300 dark:hover:bg-black/80"
        )}
